...
def get_user_streak_levels(email):
    ...
    for activity in user_activity:
        ...
        # Check if the score is more than the threshold (3)
        if avg_score >= 3:
            ...
            if consecutive_days == 2:
                streak_level += 1
                if streak_level <= 8:  # Unlock levels within the initial 8
