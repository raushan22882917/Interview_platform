...
def generate_prompt(step, question, user_input):
    ...
    if step == "Example":
        return (
            ...
            f"- **Number of Examples:** Ensure at least 3 input-output pairs.\n"
            f"- **Diversity:** Check if examples cover a variety of scenarios.\n"
            f"- **Clarity:** Evaluate whether the examples are easy to understand.\n"
            f"- **Relevance:** Confirm that the examples align with the question.\n\n"
            f"#### Feedback:\n"
            f"- Qualitative Feedback (Excellent, Very Good, Good, Needs Improvement):\n"
