...
def step():
    ...
    if request.method == 'POST':
        ...
        if current_index < len(STEPS) - 1:
            ...
            return render_template('Ai/editor.html', responses=responses, current_step=None)

    return render_template('Ai/editor.html', step=current_step, question=session['question'], responses=responses)
