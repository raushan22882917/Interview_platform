...
# Check subscription status
    ...
    for payment in payments:
        subscription_date = payment['date']
        duration = payment['months']
        
        # Calculate remaining days and expiration date
        expiration_date = subscription_date + timedelta(days=duration * 30)
        ...
        if remaining_days > 0:
            ...
            status = 'Expired'
            remaining_days = 0  # Avoid negative days

        # Append extended details to the list
