...
def generate_prompt(step, question, user_input):
    ...
    prompts = {
        "Example": f"Question: {question}\nExamples provided: {user_input}\nEvaluate examples based on diversity, clarity, relevance, and edge cases.",
        "Solution": f"Question: {question}\nUser's solution approach: {user_input}\nEvaluate accuracy, completeness, feasibility, creativity, and logical flow.",
        "Test Cases": f"Question: {question}\nTest cases: {user_input}\nEvaluate coverage, edge cases, uniqueness, and correctness.",
        "Code": f"Question: {question}\nCode snippet: {user_input}\nAssess correctness, time complexity, space complexity, readability, and modularity.",
        "Validation": f"Question: {question}\nValidation steps: {user_input}\nEvaluate test coverage, performance analysis, error handling, and completeness."
    }
    return prompts[step]
