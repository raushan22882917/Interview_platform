...
def generate_pdfs(rows, rows_per_pdf=10):
    ...
    for i in range(0, len(rows), rows_per_pdf):
        ...
        for row in rows[i:i + rows_per_pdf]:
            ...
            pdf.set_font("Arial", size=12)
            pdf.multi_cell(0, 10, clean_text(company_name))
            pdf.ln(2)
            ...
            pdf.set_font("Arial", size=12)
            pdf.multi_cell(0, 10, clean_text(user_answer))
            pdf.ln(2)
            ...
            pdf.set_font("Arial", size=12)
            pdf.cell(0, 10, str(score), ln=True)
            pdf.ln(5)  # Small spacing before the line

            # Draw a horizontal line
            pdf.set_draw_color(169, 169, 169)  # Light gray
            pdf.set_line_width(0.5)
            pdf.line(10, pdf.get_y(), 200, pdf.get_y())  # Horizontal line across the page width
