...
def generate_prompt(step, question, user_input):
    ...
    # Step 4: Code Evaluation
        ...
        return (
            ...
            f"**User's Code:**\n{user_input}\n\n"
            f"#### Evaluation Criteria:\n"
            f"- **Correctness:** Verify the code solves the problem as expected.\n"
            f"- **Time Complexity:** Assess the efficiency of the solution.\n"
            f"- **Space Complexity:** Check memory usage.\n"
            f"- **Improvements:** Suggest any optimizations or coding best practices.\n\n"
            f"#### Feedback:\n"
            f"- Qualitative Feedback (Excellent, Very Good, Good, Needs Improvement):\n"
            f"- Suggestions for improvement (if any):"
        )
