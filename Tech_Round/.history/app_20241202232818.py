...
def submit_answer_take():
    ...
    try:
        ...
        return jsonify({'error': 'Invalid data format, user_answer is required'}), 400
    ...
    if current_index < len(selected_questions):
        ...
        # Get the current attempt count from the database or session
        ...
        # Update the current index in the session
