...
def Hr_home():
    ...
    if subscription_status == 'active':
        ...
        return render_template('HR_Round/subscribe.html', button_message="Renew Subscription")
    else:
        return render_template('HR_Round/subscribehome.html', button_message="Subscribe Now")
##################################################################################
