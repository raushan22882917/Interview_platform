...
def get_db_connection():
    conn = psycopg2.connect(
        ...
        database='interview',    # Replace with your database name
        user='postgres',      # Replace with your database username
        password='22882288'  # Replace with your database password
    )
    return conn
...
def insert_question(form_data):
    ...
    query = """
    INSERT INTO intr_questions (question_text, question_type, difficulty_level, 
                           category, subtopic, job_role, experience_level, user_email)
...
""", (user_email, first_name, last_name, college_name, dob, year_of_study, graduation_year, linkedin_url, instagram_url))
        ...
        question_data = {
            ...
            "email": session["email"],  # Store the user's email from session
        }

        # Save question data to the database
        if insert_question(question_data):
   ...
   # Fetch scores for each question_id grouped by date
    ...
    return render_template('profile_details.html',
                           ...
                           percentage_scored_above_70=percentage_scored_above_70,email=session["email"],
