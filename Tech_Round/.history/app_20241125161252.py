...
def profile():
    ...
    conn = get_db_connection()
    cursor = conn.cursor()
    cursor.execute("SELECT * FROM education WHERE email = %s;", (email,))
    education_details = cursor.fetchone()

    if education_details is None:
        flash('No educational details found. Please fill out the form.', 'info')
        education_details = {
                'first_name': None,
                'last_name': None,
                'college_name': None,
    ...
    if request.method == 'POST':
        ...
        cursor.execute("""
                INSERT INTO education (
                    email, first_name, last_name, college_name, dob, 
                    year_of_study, graduation_year, linkedin_url, instagram_url
                )
        ...
        cursor.execute("SELECT * FROM education WHERE user_email = %s;", (email,))
        education_details = cursor.fetchone()
