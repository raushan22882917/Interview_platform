...
def generate_prompt(step, question, user_input):
    ...
    # Step 3: Test Case Coverage
        ...
        return (
            ...
            f"#### Evaluation Criteria:\n"
            f"- **Coverage:** Check if all possible scenarios, including edge cases, are considered.\n"
            f"- **Completeness:** Evaluate whether the test cases sufficiently test the solution.\n\n"
            f"#### Feedback:\n"
            f"- Qualitative Feedback (Excellent, Very Good, Good, Needs Improvement):\n"
            f"- Suggestions for improvement (if any):"
        )
