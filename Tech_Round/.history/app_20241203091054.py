...
def generate_prompt(step, question, user_input):
    ...
    # Step 2: Solution Approach Evaluation
        ...
        return (
            ...
            f"**Proposed Solution:**\n{user_input}\n\n"
            f"#### Evaluation Criteria:\n"
            f"- **Correctness:** Check if the solution addresses the problem.\n"
            f"- **Feasibility:** Evaluate whether the solution is practical.\n"
            f"- **Logical Flow:** Assess the flow and organization of the approach.\n"
            f"- **Completeness:** Ensure all parts of the problem are addressed.\n\n"
            f"#### Feedback:\n"
            f"- Qualitative Feedback (Excellent, Very Good, Good, Needs Improvement):\n"
            f"- Suggestions for improvement (if any):"
        )
