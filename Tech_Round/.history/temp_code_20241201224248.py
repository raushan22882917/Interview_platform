...
def step():
    ...
    if request.method == 'POST':
        ...
        if current_index < len(STEPS) - 1:
            ...
            return render_template('Ai/feedback.html', responses=responses)

    return render_template('Ai/step.html', step=current_step, question=session['question'], responses=responses)
