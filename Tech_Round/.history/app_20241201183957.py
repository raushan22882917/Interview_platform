...
# Check subscription status
    ...
    return render_template('profile_details.html',
                           ...
                           percentage_scored_above_70=percentage_scored_above_70,attempts=attempts, total_score=total_score, average_score=average_score,dates=dates,total_scores=total_scores,
