...
def generate_prompt(step, question, user_input):
    ...
    # Simulate the feedback and score extraction from the API
    feedback = "Excellent"  # This would be dynamically generated based on the evaluation of the response
    score = extract_score_from_feedback(feedback)
    
    return prompt, feedback, score
