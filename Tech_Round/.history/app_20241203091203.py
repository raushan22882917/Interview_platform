...
f"- **Diversity:** Check if the examples cover a variety of scenarios and edge cases.\n"
f"- **Clarity:** Evaluate whether the examples are clear and easy to understand.\n"
f"- **Relevance:** Confirm that the examples are directly related to the question and problem.\n\n"
f"#### Feedback:\n"
f"- **Number of Examples Feedback:** Provide feedback on whether the quantity of examples in `{user_input}` is sufficient.\n"
f"- **Diversity Feedback:** Assess the diversity of the examples, checking for coverage of various situations.\n"
f"- **Clarity Feedback:** Comment on the clarity and comprehensibility of the provided examples.\n"
f"- **Relevance Feedback:** Evaluate how well the examples align with the question and the context.\n"
