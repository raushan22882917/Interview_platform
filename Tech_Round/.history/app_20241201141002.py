...
def dashboard():
    ...
    if subscription_status == 'active':
        return render_template('dashboard.html', button_message="Start", remaining_days=remaining_days)
    elif subscription_status == 'expired':
        return render_template('dashboard.html', button_message="Renew Subscription")
    else:
        return render_template('dashboard.html', button_message="Subscribe Now")
##################################################################################
