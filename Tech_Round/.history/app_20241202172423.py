...
def generate_prompt(step, question, user_input):
    ...
    if step == "Example":
        ...
        return (
            ...
            f"Check if the user provided time complexity, space complexity, and automatically run all public and private test cases. Provide feedback on whether all test cases passed."
        )
