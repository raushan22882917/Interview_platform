...
app = Flask(__name__)
app.secret_key = os.environ.get("FLASK_SECRET_KEY", "your_secret_key")  # For security, consider using an environment variable

# Initialize the Groq API client
client = Groq(api_key=os.environ.get("GROQ_API_KEY", "your_api_key"))  # Get the Groq API key from environment variables
